...
export class Game extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.audio('alien', 'assets/alien.ogg');
    }

    create() {
        // init audio
        this.bgMusic = this.sound.add('gameMusic', { volume: 0.25, loop: true });
        this.bgMusic.play();
        this.shootSound = this.sound.add('shoot', { volume: 0.5, loop: false });
        this.alienSound = this.sound.add('alien', { volume: 0.5, loop: false });
